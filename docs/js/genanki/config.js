const MODEL_NAME = "ocloze";

const FIELDS = [{ name: "Original" }, { name: "Title" }, { name: "Remarks" }, { name: "Sources" }, { name: "Settings" }, 
                { name: "Text1" }, { name: "Text2" }, { name: "Text3" }, { name: "Text4" }, { name: "Text5" }, { name: "Text6" }, 
                { name: "Text7" }, { name: "Text8" }, { name: "Text9" }, { name: "Text10" }, { name: "Text11" }, { name: "Text12" }, 
                { name: "Text13" }, { name: "Text14" }, { name: "Text15" }, { name: "Text16" }, { name: "Text17" }, { name: "Text18" }, 
                { name: "Text19" }, { name: "Text20" }, { name: "Full" }];
